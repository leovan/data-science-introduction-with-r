...
![](images/dplyr-join-setup-1.png){fig-align="center" width=40%}
:::
::::
...
::: {.column width="50%"}
![](images/dplyr-join-setup-2.png){fig-align="center" width=60%}
:::
::::
...
![](images/dplyr-join-inner.png){fig-align="center" width=100%}
...
::: {.column width="50%"}
![](images/dplyr-join-outer.png){fig-align="center" width=60%}
:::
::::
...
::: {.column width="50%"}
![](images/dplyr-join-one-to-many.png){fig-align="center" width=80%}
...
::: {.column width="50%"}
![](images/dplyr-join-many-to-many.png){fig-align="center" width=60%}
...
![](images/dplyr-join-semi.png){fig-align="center" width=70%}
:::

::: {.column width="50%"}
重要的是存在匹配，匹配了哪条观测则无关紧要。这说明筛选连接不会像合并连接那样造成重复的行。

![](images/dplyr-join-semi-many.png){fig-align="center" width=60%}

半连接的逆操作是反连接。反连接保留 `x` 表中那些没有匹配 `y` 表的行。

![](images/dplyr-join-anti.png){fig-align="center" width=60%}
:::
::::
...
ggsave("tmp/forcats-relig-summary.png", width = 6, height = 5, dpi = 150)
```

![](tmp/forcats-relig-summary.png){fig-align="center" width=100%}
:::
::::
...
p <- ggplot(relig_summary, aes(tvhours, fct_reorder(relig, tvhours))) +
  geom_point()
ggsave("tmp/forcats-relig-summary-reorder.png", width = 6, height = 5, dpi = 100)
```

![](tmp/forcats-relig-summary-reorder.png){fig-align="center" width=100%}
:::
::::
...
```{r}
update(
  datetime, year = 2020, month = 2, mday = 2, hour = 2)
```
:::
::::
...
```{r}
one_pm <- ymd_hms(
  "2016-03-12 13:00:00", tz = "America/New_York")
one_pm
```
...
::: {.column width="50%"}
![](images/purrr-lists-map2.png){fig-align="center" width=100%}
...
::: {.column width="50%"}
![](images/purrr-lists-pmap-unnamed.png){fig-align="center" width=100%}
:::
::::
...
![](images/purrr-lists-pmap-named.png){fig-align="center" width=100%}
:::
::::
...
::: {.column width="50%"}
![](images/purrr-lists-invoke.png){fig-align="center" width=100%}
