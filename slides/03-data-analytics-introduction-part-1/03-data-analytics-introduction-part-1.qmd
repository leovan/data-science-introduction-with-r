...
::: {.center}
![图片来源：<https://www.storybench.org/getting-started-with-tidyverse-in-r/>](images/tidyverse.png){fig-align="center" width=100%}
:::
...
这种方法的最大缺点是，你必须为每个中间结果建立一个变量。这样会造成两个问题：代码中充斥着大量不必要的变量；你必须在每一行代码中小心翼翼地修改变量后缀。使用管道，可以表示为：
:::
...
- 它们更易于重复使用。 R 基础包中的函数会继承操作系统的功能，并依赖环境变量，因此，可以在你的计算机上正常运行的代码在他人计算机上不一定能正常运行。
...
::: {.center}
![](images/transform-logical.png){fig-align="center" width=60%}
:::
...
ggsave("tmp/dplyr-summarise-delays.png", width = 5, height = 4.8, dpi = 150)
```

![](tmp/dplyr-summarise-delays.png){fig-align="center" width=100%}
:::
::::
...
ggsave("tmp/dplyr-summarise-delays-mean.png", width = 6, height = 4, dpi = 150)
```

![](tmp/dplyr-summarise-delays-mean.png){fig-align="center" width=100%}
:::
::::
...
::: {.center}
![](images/tidyr-column-row-cell.png){fig-align="center" width=60%}
:::
...
::: {.center}
![](images/tidyr-pivot-longer.png){fig-align="center" width=70%}
:::
...
::: {.center}
![](images/tidyr-pivot-wider.png){fig-align="center" width=60%}
:::
...
::: {.center}
![](images/tidyr-separate.png){fig-align="center" width=80%}
:::
...
::: {.center}
![](images/tidyr-unite.png){fig-align="center" width=80%}
:::
